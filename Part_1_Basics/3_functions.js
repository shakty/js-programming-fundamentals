...
// a. Create a function named `printSentence` that takes a name as
...
// Hint: if you haven't restarted Atom, you still have access to the objects
...
// parameters of type person, and print the same string as before,
...
// parameters, so the one with input parameters is the to be preferred
// in most situations.

// b. A function can also modify or create other variables inside its scope.
// Modify the whoIsYounger function so that it does not return a value, but
// instead it stores the result in a global variable youngest.
...
// what was inside all the previous ones. But what happens if you had two
