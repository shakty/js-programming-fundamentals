...
morph = 1;
typeof morph;
// It is good practice to always add the semicolon at the of a line.
...
// There are other two primitive types: 'object', and 'function' and we will
// learn more about those in the next exercises.
...
// d. If you made it until now, you may prefer a more positive message
...
// e. Now shout it loud and make the it upper case.
// Hint: Use toUpperCase.
finalStr = finalStr.toUpperCase();

// f. Let's be honest. An upper case sentence must end with an exclamation mark.
